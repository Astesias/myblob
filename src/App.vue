...
export default {
    ...
    methods: {
        ...
        flatenLogin() {
            // if(to!=null){
            //     this.loginFold = to;
            //     console.log(to?"失去焦点":"获得焦点")
            //     console.log(this.loginFoldFocus)
            //     if(to && this.loginFoldFocus){
            //         this.loginFold = true;
            //         this.loginFoldFocus = false;
            //     }
            //     else if(to && !this.loginFoldFocus){
            //         this.loginFold = false;
            //         this.loginFoldFocus = true;
            //     }
            //     else{
            //         this.loginFold = false;
            //         this.loginFoldFocus = true;
