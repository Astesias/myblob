...
<div id="head" class="head_item hnormal">
    <div id="nav-left" class="left_item lnormal noin">
        <a class="inline-container">
            ...
            <div id="brief" class="text" style="white-space: pre-wrap;" v-show="(show_brief||show_center_brief)">Miku? Miku!</div>
        </a>

    </div>

    <div id="nav-mid" class="base_left lnormal">
        <a class="inline-container" id="foldbtn" v-show="!profileHide" @click="foldProfile">
        ...
        <div class="search-container">
            <div class="inline-container">
                <div class="search-container2">
                    ...
                    <svg t="1712625367754" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" 
                    p-id="1543" width="200" height="200" @click="clicklogin">
    ...
    <div id="nav-right" v-show="headFlatten||wt<=1">
        <a class="inline-container" @click="$router.push('/article/aboutme')">
        ...
        <a class="inline-container" @click="$router.push('/comment')">
        ...
        <a class="inline-container" @click="$router.push('/selected')">
    ...
    <div id="nav-media2" v-show="wt>=2" :style="{ 'background-color': headFlatten ? 'rgba(0,0,0,0.2)' : '' }">
...
<div id="login-tab" class="base_head hnormal login-item" v-show="loginFlatten">
    <div class="login-container">
        ...
        <button class="btn login-item text" @click="clicklogin">登录</button>
    </div>
</div>
</template>
    ...
    methods: {
        ...
        foldProfile() {
            if (!this.profileFold) {
                ...
                dqc_switch(".sub", "subhide", ["sub", "subhide"]);
                dqc_switch(".parentnofold", "parentfold", ["parentfold", "parentnofold"]);
            } else {
